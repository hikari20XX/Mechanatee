...
impl Default for CancelGoal_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::srv::rmw::CancelGoal_Request::default())
  }
}

impl rosidl_runtime_rs::Message for CancelGoal_Request {
  type RmwMsg = crate::srv::rmw::CancelGoal_Request;

  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        goal_info: crate::msg::GoalInfo::into_rmw_message(std::borrow::Cow::Owned(msg.goal_info)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        goal_info: crate::msg::GoalInfo::into_rmw_message(std::borrow::Cow::Borrowed(&msg.goal_info)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      goal_info: crate::msg::GoalInfo::from_rmw_message(msg.goal_info),
    }
  }
}
...
pub struct CancelGoal_Response {
    pub return_code: i8,
    pub goals_canceling: Vec<crate::msg::GoalInfo>,
}
...
impl Default for CancelGoal_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::srv::rmw::CancelGoal_Response::default())
  }
}

impl rosidl_runtime_rs::Message for CancelGoal_Response {
  type RmwMsg = crate::srv::rmw::CancelGoal_Response;
    ...
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        goals_canceling: msg.goals_canceling
          .into_iter()
          .map(|elem| crate::msg::GoalInfo::into_rmw_message(std::borrow::Cow::Owned(elem)).into_owned())
          .collect(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      return_code: msg.return_code,
        goals_canceling: msg.goals_canceling
          .iter()
          .map(|elem| crate::msg::GoalInfo::into_rmw_message(std::borrow::Cow::Borrowed(elem)).into_owned())
          .collect(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      ...
      goals_canceling: msg.goals_canceling
          .into_iter()
          .map(crate::msg::GoalInfo::from_rmw_message)
          .collect(),
    }
  }
}
...
extern "C" {
    fn rosidl_typesupport_c__get_service_type_support_handle__action_msgs__srv__CancelGoal() -> *const std::os::raw::c_void;
}
...
impl rosidl_runtime_rs::Service for CancelGoal {
  type Request = crate::srv::CancelGoal_Request;
  type Response = crate::srv::CancelGoal_Response;
...
#[link(name = "action_msgs__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__action_msgs__srv__CancelGoal_Request() -> *const std::os::raw::c_void;
}
...
#[derive(Clone, Debug, PartialEq, PartialOrd)]
pub struct CancelGoal_Request {
    pub goal_info: crate::msg::rmw::GoalInfo,
}
...
#[link(name = "action_msgs__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__action_msgs__srv__CancelGoal_Response() -> *const std::os::raw::c_void;
}
...
pub struct CancelGoal_Response {
    pub return_code: i8,
    pub goals_canceling: rosidl_runtime_rs::Sequence<crate::msg::rmw::GoalInfo>,
}
...
impl rosidl_runtime_rs::RmwMessage for CancelGoal_Response where Self: Sized {
  ...
  impl rosidl_runtime_rs::Service for CancelGoal {
    type Request = crate::srv::rmw::CancelGoal_Request;
    type Response = crate::srv::rmw::CancelGoal_Response;
