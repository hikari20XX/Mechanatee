...
static const _UnboundedSequences_type_support_symbol_names_t _UnboundedSequences_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_msgs, msg, UnboundedSequences)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_msgs, msg, UnboundedSequences)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_msgs, msg, UnboundedSequences)() {
  return &::test_msgs::msg::rosidl_typesupport_c::UnboundedSequences_message_type_support_handle;
}
