  ...
  void * untyped_ros_message)
{
  ...
  _BasicTypes__ros_msg_type * ros_message = static_cast<_BasicTypes__ros_msg_type *>(untyped_ros_message);
  // Field name: bool_value
  {
    uint8_t tmp;
    cdr >> tmp;
...
static uint32_t _BasicTypes__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_msgs__msg__BasicTypes(
...
static size_t _BasicTypes__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_msgs__msg__BasicTypes(
