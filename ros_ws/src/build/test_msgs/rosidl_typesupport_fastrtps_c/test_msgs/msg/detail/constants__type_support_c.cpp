...
#include "test_msgs/msg/detail/constants__rosidl_typesupport_fastrtps_c.h"
...
using _Constants__ros_msg_type = test_msgs__msg__Constants;
  ...
  void * untyped_ros_message)
{
  ...
  _Constants__ros_msg_type * ros_message = static_cast<_Constants__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
static size_t _Constants__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_msgs__msg__Constants(
