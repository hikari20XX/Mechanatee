...
#include "geometry_msgs/msg/detail/wrench__rosidl_typesupport_fastrtps_c.h"
...
using _Wrench__ros_msg_type = geometry_msgs__msg__Wrench;
  ...
  void * untyped_ros_message)
{
  ...
  _Wrench__ros_msg_type * ros_message = static_cast<_Wrench__ros_msg_type *>(untyped_ros_message);
  // Field name: force
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _Wrench__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_geometry_msgs__msg__Wrench(
