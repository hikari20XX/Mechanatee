...
#include "geometry_msgs/msg/detail/accel_with_covariance_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _AccelWithCovarianceStamped__ros_msg_type = geometry_msgs__msg__AccelWithCovarianceStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AccelWithCovarianceStamped__ros_msg_type * ros_message = static_cast<const _AccelWithCovarianceStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AccelWithCovarianceStamped__ros_msg_type * ros_message = static_cast<_AccelWithCovarianceStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _AccelWithCovarianceStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_geometry_msgs__msg__AccelWithCovarianceStamped(
