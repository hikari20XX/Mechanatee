...
#include "geometry_msgs/msg/detail/vector3__rosidl_typesupport_fastrtps_c.h"
...
using _Vector3__ros_msg_type = geometry_msgs__msg__Vector3;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Vector3__ros_msg_type * ros_message = static_cast<const _Vector3__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr << ros_message->x;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Vector3__ros_msg_type * ros_message = static_cast<_Vector3__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static size_t _Vector3__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_geometry_msgs__msg__Vector3(
