...
#include "geometry_msgs/msg/detail/twist_with_covariance_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _TwistWithCovarianceStamped__ros_msg_type = geometry_msgs__msg__TwistWithCovarianceStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TwistWithCovarianceStamped__ros_msg_type * ros_message = static_cast<const _TwistWithCovarianceStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TwistWithCovarianceStamped__ros_msg_type * ros_message = static_cast<_TwistWithCovarianceStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _TwistWithCovarianceStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_geometry_msgs__msg__TwistWithCovarianceStamped(
