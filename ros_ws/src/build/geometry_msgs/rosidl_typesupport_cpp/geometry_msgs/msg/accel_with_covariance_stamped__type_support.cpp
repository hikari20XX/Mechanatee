...
static const _AccelWithCovarianceStamped_type_support_symbol_names_t _AccelWithCovarianceStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, geometry_msgs, msg, AccelWithCovarianceStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, geometry_msgs, msg, AccelWithCovarianceStamped)),
  }
};
...
{
  return &::geometry_msgs::msg::rosidl_typesupport_cpp::AccelWithCovarianceStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, geometry_msgs, msg, AccelWithCovarianceStamped)() {
  return get_message_type_support_handle<geometry_msgs::msg::AccelWithCovarianceStamped>();
}
