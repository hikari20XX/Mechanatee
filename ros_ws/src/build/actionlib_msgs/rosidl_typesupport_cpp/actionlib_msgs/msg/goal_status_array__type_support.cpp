...
static const _GoalStatusArray_type_support_symbol_names_t _GoalStatusArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, actionlib_msgs, msg, GoalStatusArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, actionlib_msgs, msg, GoalStatusArray)),
  }
};
...
{
  return &::actionlib_msgs::msg::rosidl_typesupport_cpp::GoalStatusArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, actionlib_msgs, msg, GoalStatusArray)() {
  return get_message_type_support_handle<actionlib_msgs::msg::GoalStatusArray>();
}
