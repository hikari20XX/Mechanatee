...
static const _VariousTypes_type_support_symbol_names_t _VariousTypes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rclrs_example_msgs, msg, VariousTypes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rclrs_example_msgs, msg, VariousTypes)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rclrs_example_msgs, msg, VariousTypes)() {
  return &::rclrs_example_msgs::msg::rosidl_typesupport_c::VariousTypes_message_type_support_handle;
}
