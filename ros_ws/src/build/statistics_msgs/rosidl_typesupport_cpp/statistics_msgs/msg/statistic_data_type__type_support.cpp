...
static const _StatisticDataType_type_support_symbol_names_t _StatisticDataType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, statistics_msgs, msg, StatisticDataType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, statistics_msgs, msg, StatisticDataType)),
  }
};
...
{
  return &::statistics_msgs::msg::rosidl_typesupport_cpp::StatisticDataType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, statistics_msgs, msg, StatisticDataType)() {
  return get_message_type_support_handle<statistics_msgs::msg::StatisticDataType>();
}
