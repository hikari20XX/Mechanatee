...
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__rosgraph_msgs__msg__Clock() -> *const std::os::raw::c_void;
}
...
impl Default for Clock {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::msg::rmw::Clock::default())
  }
}

impl rosidl_runtime_rs::Message for Clock {
  type RmwMsg = crate::msg::rmw::Clock;
