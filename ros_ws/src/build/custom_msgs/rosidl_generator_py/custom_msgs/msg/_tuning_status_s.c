...
bool custom_msgs__msg__tuning_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._tuning_status.TuningStatus", full_classname_dest, 43) == 0);
  }
  custom_msgs__msg__TuningStatus * ros_message = _ros_message;
  {  // sec
...
{
  /* NOTE(esteve): Call constructor of TuningStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._tuning_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TuningStatus");
