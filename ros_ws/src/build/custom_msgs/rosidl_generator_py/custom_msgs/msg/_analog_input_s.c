...
bool custom_msgs__msg__analog_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._analog_input.AnalogInput", full_classname_dest, 41) == 0);
  }
  custom_msgs__msg__AnalogInput * ros_message = _ros_message;
  {  // sec
...
{
  /* NOTE(esteve): Call constructor of AnalogInput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._analog_input");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AnalogInput");
