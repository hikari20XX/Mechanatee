...
bool custom_msgs__msg__servo_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._servo_speed.ServoSpeed", full_classname_dest, 39) == 0);
  }
  custom_msgs__msg__ServoSpeed * ros_message = _ros_message;
  {  // sec
...
{
  /* NOTE(esteve): Call constructor of ServoSpeed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._servo_speed");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServoSpeed");
