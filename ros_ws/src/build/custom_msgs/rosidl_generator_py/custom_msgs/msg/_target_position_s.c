...
bool custom_msgs__msg__target_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._target_position.TargetPosition", full_classname_dest, 47) == 0);
  }
  custom_msgs__msg__TargetPosition * ros_message = _ros_message;
  {  // sec
...
PyObject * custom_msgs__msg__target_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._target_position");
