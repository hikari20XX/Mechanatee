...
class Metaclass_ServoFeedback(type):
    """Metaclass of message 'ServoFeedback'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.msg.ServoFeedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__servo_feedback
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__servo_feedback
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__servo_feedback
            cls._TYPE_SUPPORT = module.type_support_msg__msg__servo_feedback
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__servo_feedback
...
class ServoFeedback(metaclass=Metaclass_ServoFeedback):
    """Message class 'ServoFeedback'."""
