...
#include "custom_msgs/msg/detail/target_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::TargetPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::TargetPosition *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_TargetPosition__handle;
}
