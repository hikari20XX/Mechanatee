...
#include "custom_msgs/msg/detail/updated_pid_params__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::UpdatedPIDParams & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::UpdatedPIDParams & ros_message)
{
  // Member: sec
  cdr >> ros_message.sec;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
max_serialized_size_UpdatedPIDParams(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::UpdatedPIDParams *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::UpdatedPIDParams *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UpdatedPIDParams__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msgs::msg::UpdatedPIDParams *>(
...
static size_t _UpdatedPIDParams__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UpdatedPIDParams(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UpdatedPIDParams__callbacks = {
  "custom_msgs::msg",
  "UpdatedPIDParams",
...
static rosidl_message_type_support_t _UpdatedPIDParams__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UpdatedPIDParams__callbacks,
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_UpdatedPIDParams__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, UpdatedPIDParams)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_UpdatedPIDParams__handle;
}
