...
static const _UpdatedPIDParams_type_support_symbol_names_t _UpdatedPIDParams_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, UpdatedPIDParams)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msgs, msg, UpdatedPIDParams)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_msgs, msg, UpdatedPIDParams)() {
  return &::custom_msgs::msg::rosidl_typesupport_c::UpdatedPIDParams_message_type_support_handle;
}
