...
#include "custom_msgs/msg/detail/target_position__rosidl_typesupport_fastrtps_c.h"
...
using _TargetPosition__ros_msg_type = custom_msgs__msg__TargetPosition;
...
size_t get_serialized_size_custom_msgs__msg__TargetPosition(
  const void * untyped_ros_message,
...
static uint32_t _TargetPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__TargetPosition(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__TargetPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _TargetPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__TargetPosition(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, TargetPosition)() {
