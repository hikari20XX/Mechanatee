...
#include "custom_msgs/msg/detail/voltage_reading__rosidl_typesupport_fastrtps_c.h"
...
using _VoltageReading__ros_msg_type = custom_msgs__msg__VoltageReading;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VoltageReading__ros_msg_type * ros_message = static_cast<const _VoltageReading__ros_msg_type *>(untyped_ros_message);
  // Field name: sec
  {
    cdr << ros_message->sec;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _VoltageReading__ros_msg_type * ros_message = static_cast<_VoltageReading__ros_msg_type *>(untyped_ros_message);
  // Field name: sec
  {
    cdr >> ros_message->sec;
  }
...
size_t get_serialized_size_custom_msgs__msg__VoltageReading(
  const void * untyped_ros_message,
...
static uint32_t _VoltageReading__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__VoltageReading(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__VoltageReading(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _VoltageReading__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__VoltageReading(
...
static message_type_support_callbacks_t __callbacks_VoltageReading = {
  "custom_msgs::msg",
  "VoltageReading",
...
static rosidl_message_type_support_t _VoltageReading__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VoltageReading,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, VoltageReading)() {
  return &_VoltageReading__type_support;
}
