...
static const _TransitionDescription_type_support_symbol_names_t _TransitionDescription_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lifecycle_msgs, msg, TransitionDescription)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lifecycle_msgs, msg, TransitionDescription)),
  }
};
...
{
  return &::lifecycle_msgs::msg::rosidl_typesupport_cpp::TransitionDescription_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lifecycle_msgs, msg, TransitionDescription)() {
  return get_message_type_support_handle<lifecycle_msgs::msg::TransitionDescription>();
}
