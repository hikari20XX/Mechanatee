  ...
  void * untyped_ros_message)
{
  ...
  _DescribeParameters_Request__ros_msg_type * ros_message = static_cast<_DescribeParameters_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: names
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
  ...
  void * untyped_ros_message)
{
  ...
  _DescribeParameters_Response__ros_msg_type * ros_message = static_cast<_DescribeParameters_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: descriptors
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
