...
static const _ParameterEventDescriptors_type_support_symbol_names_t _ParameterEventDescriptors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rcl_interfaces, msg, ParameterEventDescriptors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, msg, ParameterEventDescriptors)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rcl_interfaces, msg, ParameterEventDescriptors)() {
  return &::rcl_interfaces::msg::rosidl_typesupport_c::ParameterEventDescriptors_message_type_support_handle;
}
