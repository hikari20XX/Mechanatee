...
impl Default for Duration {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::msg::rmw::Duration::default())
  }
}

impl rosidl_runtime_rs::Message for Duration {
  type RmwMsg = crate::msg::rmw::Duration;
...
impl Default for Time {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::msg::rmw::Time::default())
  }
}

impl rosidl_runtime_rs::Message for Time {
  type RmwMsg = crate::msg::rmw::Time;
