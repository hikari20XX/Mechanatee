...
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__unique_identifier_msgs__msg__UUID() -> *const std::os::raw::c_void;
}
...
impl Default for UUID {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::msg::rmw::UUID::default())
  }
}

impl rosidl_runtime_rs::Message for UUID {
  type RmwMsg = crate::msg::rmw::UUID;
